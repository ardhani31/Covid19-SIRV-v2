...
class SIR(ModelBase):
    ...
    NAME = "SIR"
    # names of parameters
    PARAMETERS = ["rho", "sigma", "theta", "kappa","phi","beta","myu","gammaa","delta","vacrate"]
    DAY_PARAMETERS = ["1/beta [day]", "1/gamma [day]", "alpha1 [-]", "1/alpha2 [day]", "Vaccination rate[target population/completion time"]
    ...
    EXAMPLE = {
        ...
        ModelBase.PARAM_DICT: {
            "rho": 0.2, "sigma": 0.075, "theta": 0.002, "kappa": 0.005, "vacrate": 0.186,
        },
        ModelBase.Y0_DICT: {
    ...
    def __init__(self, population, rho, sigma, theta, kappa, phi, myu, vacrate):
        # Total population
